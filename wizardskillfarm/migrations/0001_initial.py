    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='eveonline.evecharacter')),
                ('skill_name', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='corptools.eveitemtype')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excluded_skills', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wizardskillfarm.excludedcharacterfarmingskills')),
                ('farming_skills', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wizardskillfarm.characterfarmingskill')),
            ],
        ),
    ]
